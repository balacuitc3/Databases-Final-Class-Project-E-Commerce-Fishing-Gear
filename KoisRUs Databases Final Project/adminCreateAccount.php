...
<!-- This will allow a user to create an admin account-->
<html>
    <head>
        <meta charset="UTF-8">
            <title>Sign Up</title>
    ...
    <body>
        <h1 style="background-color:#F1FFB0">Create an Admin account below:</h1>
        <form action="adminSignConfirm.php" method="POST" style="width:60%; padding-left:200px">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="a_birthdate" placeholder="a_birthdate" required>
        </div><br>
        <div class="form-group">
            <label>Age:</label>
