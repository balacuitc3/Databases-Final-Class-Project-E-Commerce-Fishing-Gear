...
<html>
    ...
    <body>
        ...
        <form action="ownerSignConfirm.php" method="POST" style="width:60%; padding-left:200px">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="birthdate" name="birthdate" placeholder="birthdate" required>
        </div><br>
        <div class="form-group">
            <label>Age:</label>
            <input class="form-control" type="age" name="age" placeholder="Age" required>
        </div><br>
        <div class="form-group">
