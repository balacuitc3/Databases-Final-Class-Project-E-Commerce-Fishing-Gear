		...
		<nav class="navbar navbar-inverse">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
			    	...
			    	<div class="dropdown">
			        	<a href = "productlist1.php"><button class="dropbtn">Products</button></a>
			        	<div class="dropdown-content">
			            	<a href = "adminProduct1.php">Fishing Poles and Lines</a>
							
			            	<a href = "adminProduct2.php">Baits and Hooks</a>
							
			            	<a href = "adminProduct3.php">Apparel</a>
							
			            	<a href = "adminProduct4.php">Books</a>
			         	</div>
			      	</div>
                            <!-- add search form -->
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="adminAccount.php"><span class="glyphicon glyphicon-user"></span>My Account</a></li>
