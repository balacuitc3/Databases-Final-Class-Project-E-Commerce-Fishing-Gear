...
<link rel="stylesheet" type="text/css" href="stylesheet.css">
    ...
    <! banner >
    <img src= "http://www.stormfishing.com.au/media/3638/rip-roach-seeker-jerk-web-banner.jpg?anchor=center&mode=crop&width=1800&height=460&quality=85"
     alt ="banner" class="imgbanner">
    ...
    <img src= "https://ae01.alicdn.com/kf/HTB19VPNJFXXXXX_XpXXq6xXFXXXm/Hot-Brand-Soft-Baits-Saltwater-Freshwater-Bass-Fishing-lures-Silicone-Artificial-Fish-Bait-for-Fishing-Tackle.jpg_640x640.jpg"
     ...
     <! add to cart buttons>
    <?php
    $results = mysqli_query($db, "SELECT * FROM products WHERE id_product= 9 OR id_product= 10 OR id_product= 11 OR id_product= 12 OR id_product= 13 OR id_product= 14 OR id_product= 15 OR id_product= 16");
