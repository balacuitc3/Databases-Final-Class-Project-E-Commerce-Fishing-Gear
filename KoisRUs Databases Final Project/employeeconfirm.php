<?php
    ...
    $query = mysqli_query($db, "SELECT * FROM Employee WHERE e_username='$username'"); //check the employee table
                    ...
                    if($password == $table_password)
                        {
                            ...
                            print '<script>window.location.assign("employeeHome.php");</script>'; 
                        }
