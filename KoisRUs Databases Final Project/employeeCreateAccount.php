...
<html>
    ...
    <body>
        ...
        <form action="employeesignupconfirm.php" method="POST" style="width:60%; padding-left:200px">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="a_birthdate" placeholder="e_birth_date" required>
        </div><br>
        <div class="form-group">
