				...
				<ul class="nav navbar-nav">
			    	...
			    	<div class="dropdown">
			        	...
			        	<div class="dropdown-content">
			            	<a href = "productlist1.php">Fishing Poles and Lines</a>
							
			            	<a href = "productlist2.php">Baits and Hooks</a>
							
			            	<a href = "productlist3.php">Apparel</a>
							
			            	<a href = "productlist4.php">Books</a>
			         	</div>
			      	</div>
                            <!-- add search form -->
