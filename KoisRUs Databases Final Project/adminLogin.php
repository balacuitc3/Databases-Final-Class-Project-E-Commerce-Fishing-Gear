<!DOCTYPE html><!--This is the Admin Login page of the Fishing Website-->
    ...
    <body>
        <div class="jumbotron" style="background-color:#F1FFB0">
            <div class="container text-center">
                <link rel="stylesheet" type="text/css" href="style.css">
                    <h1 title="Customer">Adminstrator Login</h1>
                <hr >
            </div>
        </div>
        <p>This is the administartor login page<br>Enter the necessary information below to login.</p>
        <!--Input your Login information here-->
        <form method="POST" action="adminconfirm.php">
            <!--Put your username here-->
            <label for="usr">Admin Log in:</label><br>
